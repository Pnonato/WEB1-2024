...
<html lang="pt-BRs">
  <head>
    ...
    <title>Ifitness - Página Login</title>
  </head>
  <body>
					...
					<h1 class="text-center">Login</h1>
						...
						<div class="input-group mb-3">
								<span class="input-group-text">
									<img alt="Campo para informar o E-mail" src="img/envelope.svg" width="32" height="32">
								</span>
						...
						<div class="input-group mb-3">
								<span class="input-group-text">
									<img alt="Campo para informar a senha" src="img/file-lock.svg" width="32" height="32">
								</span>
