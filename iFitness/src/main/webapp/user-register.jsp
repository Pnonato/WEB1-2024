...
<html lang="pt-BR">
  <head>
	...
	<link href="css/erros.css" rel="stylesheet">
    
    <title>iFitness - Página Cadastro</title>
  </head>
  <body>
   	...
   	<div class="col-lg-6 offset-lg-3 col-sm-12">
   				<form action="userRegister" method="post" id="form1">
   						...
   						<div class="mb-2">
   							...
   							<input type="date" name="dateOfBirth" id="dateOfBirth" class="form-control" required="required" max="2012-12-31">
   							<span id="4" ></span>
   						</div>
